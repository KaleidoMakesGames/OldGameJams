...
namespace PolyLabel {
    public class PolyLabel {
        ...
        Cell GetCentroidCell(List<Vector2> polygon) {
            float area = 0;
            float x = 0;
            float y = 0;
        ...
        public Cell GetPolyLabel(List<Vector2> polygon, float precision = 1.0f, bool debug = false) {
        ...
        public class Cell {
            ...
            float PointToPolygonDist(float x, float y, List<Vector2> polygon) {
                bool inside = false;
            ...
            float GetSeqDistSq(float px, float py, Vector2 a, Vector2 b) {
                float x = a.x;
                float y = a.y;
                float dx = b.x - x;
                float dy = b.y - y;
